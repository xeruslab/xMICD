...
- xMICD is deterministic given fixed embeddings and groupings
- Anchors can be exported and reused across experiments
- No stochastic training or optimization is involved
...
If you use xMICD in your work, please cite the associated paper or repository.
